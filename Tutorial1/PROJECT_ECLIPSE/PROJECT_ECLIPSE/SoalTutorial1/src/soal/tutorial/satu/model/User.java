...
public class User {
	...
	public User(Integer idPengguna, String username, String password, String namaLengkap, String nIK, String noHp,
			String email, Date tglLahir, String fotoFilePath, String scanIjazahFilePath, String scanKtpFilePath,
			String scanSkckFilePath, String scanNpwpFilePath, Boolean flagSynchronized, Boolean flagAktif) {
		super();
